...
export class BooksService {
  ...
  getBooks(params: Object = null) {
    let options = this.requestOptions(params);
    return this.http.get(this.url_base + '/getBooks', options);
  }

  
  saveBook(body: Object) {
    let options = this.requestOptions(null);
    return this.http.post(this.url_base + '/saveBook', body, options);
  }

  deleteBook(body: Object) {
    let options = this.requestOptions(null);
    return this.http.post(this.url_base + '/deleteBook', body, options);
  }
}
